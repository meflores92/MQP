...
/*
 * Arguments    : const creal32_T rxWaveform[460800]
 * Return Type  : double
 */
double SyncFrameRecover(const creal32_T rxWaveform[460800])
{
  double refGrid[480];
  int i;
  ...
  return b_nrTimingEstimate(rxWaveform, refGrid) - 1644.0;
  /* timingOffset = nrTimingEstimateOpt(rxWaveform,refGrid,0,rxSampleRate) -
   * samplesPerSymbol; */
}

/*
 * File trailer for SyncFrameRecover.c
 *
 * [EOF]
 */

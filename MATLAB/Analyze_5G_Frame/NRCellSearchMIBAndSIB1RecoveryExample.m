...
% burst carrying the MIB, CORESET0, PDCCH and PDSCH carrying SIB1 by using
...
% received waveform.
% * The minimum channel bandwidth to determine CORESET0 frequency
...
if loadFromFile
    ...
    CenterFrequency = 3619200000;
    Serial = '3164073';
    RadioGain = 70;
    burst = 5;
    radio = comm.SDRuReceiver('Platform', 'B210','SerialNum', Serial, 'MasterClockRate', RadioMasterClockRate, 'SamplesPerFrame', 200000,...
...
searchBW = 6*scsSSB;
[rxWaveform,freqOffset,NID2] = hSSBurstFrequencyCorrect(rxWaveform,rxSampleRate);
...
frameOffset = hTimingOffsetToFrame(refBurst.BlockPattern, refBurst.L_max,timingOffset,ssbIndex,rxSampleRate);
disp(' Frameoffset:')
disp(frameOffset);

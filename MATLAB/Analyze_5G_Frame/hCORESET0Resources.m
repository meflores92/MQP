%hCORESET0Resources CORESET0 resources
%   [NRB,NSYM,OFFSET,MUXPATTERN,TAB] = ...
%           hCORESET0Resources(INDEX,SCS,MINCHANBW,KSSB) returns CORESET0
%   resources parameters from TS 38.213 Section 13 Tables 13-1 to 13-10
%   corresponding to a row index INDEX (4 MSBs of PDCCHConfigSIB1 in MIB).

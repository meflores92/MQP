...
int main(int argc, char* argv[]) {
	...
	char* device_args = "serial=3164073, num_recv_frames = 256, recv_frame_size = 7680"; // num_recv_frames = 1024, recv_frame_size = 7680 for double
	size_t channel = 0;
